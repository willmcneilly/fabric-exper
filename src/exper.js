(function() {
  $(document).ready(function() {
    var canvasHeight, canvasObj, font, getOffsetPosition, getOffsetPositionNew, masterGroup, masterMasterGroup, shapeOne, shapeThree, shapeTwo, templateRealWorldHeight, templateRealWorldWidth, templateShape, textObj;
    ...
    masterMasterGroup = new fabric.Group([masterGroup], {
      height: templateRealWorldHeight + 20,
      width: templateRealWorldWidth + 20
    });
    ...
    masterGroup.forEachObject(function(obj) {
    ...
    return window.masterMasterGroup = masterMasterGroup;
  });
}).call(this);
